  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmDialog
        ...
        description={`Apakah Anda yakin ingin menghapus seluruh log audit dari sistem "${schemaTab ? tabs.find((t) => t.id === schemaTab)?.label : "Semua Sistem"}"? Tindakan ini bersifat permanen dan tidak dapat dibatalkan.`}
        confirmText="Hapus Log Audit"
        cancelText="Batal"
        variant="danger"
